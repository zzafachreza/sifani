            ...
            if (response.didCancel) {
                ...
                if (response?.assets && response.assets.length > 0) {
                    ...
                    if (image.fileSize <= 5000000) {
                        ...
                        setKirim({
                            ...kirim,
                            istri_foto: source.uri, // Simpan URI ke state
                        });
                    } else {
                        showMessage({
    ...
    const UploadFoto = ({ onPress1, onPress2, label, foto }) => {
        return (
            <View
                ...
                <Image
                    source={{
                        uri: !kirim.istri_foto ? 'https://zavalabs.com/nogambar.jpg' : kirim.istri_foto,
                    }}
                    style={{
                        width: '50%',
                        alignSelf: 'center',
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <MyInput value={kirim.istri_nama} label="Nama" onChangeText={x => {
                ...
                <MyGap jarak={10} />
                <MyInput value={kirim.istri_tempat_lahir} label="Tempat dan Tanggal lahir" onChangeText={x => {

                    setKirim({
                        ...kirim,
                        istri_tempat_lahir: x
                    })
                ...
                <MyGap jarak={10} />
                <MyInput value={kirim.istri_pekerjaan} label="Pekerjaan" onChangeText={x => {
                ...
                <MyGap jarak={10} />
                <MyInput keyboardType="number-pad" maxLength={15} value={kirim.istri_telepon} label="Telepon / Nomor HP" onChangeText={x => {
                ...
                <MyInput value={kirim.istri_alamat} label="Alamat" onChangeText={x => {
                ...
                <MyGap jarak={20} />
                <UploadFoto onPress2={() => getGallery(1)} label="Upload pas foto (latar biru)"  foto={kirim.istri_foto}/>
                <MyGap jarak={20} />
